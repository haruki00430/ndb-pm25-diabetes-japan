...
Prefecture-level mean HbA1c (%) was derived from the 10th National Database (NDB) Open Data specific health checkups examination tables (fiscal year 2022) 11). HbA1c was calculated as a weighted average from stratum counts using prespecified stratum midpoints.
